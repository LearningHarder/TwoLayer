...
class TwoLayerNet(object):
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            ii_ = it % iterations_per_epoch
            # print(ii_* batch_size)
            ...
            val_loss = self.loss(X_val, y=y_val, reg=reg, testflag= True)
            ...
            if verbose and it % 100 == 0:
                print('iteration %d / %d: train_loss %f val_loss %f' % (it, num_iters, train_loss,val_loss))
